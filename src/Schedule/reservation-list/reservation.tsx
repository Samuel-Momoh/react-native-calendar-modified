...
// @ts-expect-error
import { RESERVATION_DATE } from 'react-native-calendars/src/testIDs';
...
class Reservation extends Component<ReservationProps> {
  ...
  render() {
    const { item, date, hideDate } = this.props;
    ...
    return (
      <View style={this.style.container}>
        {hideDate ? null : this.renderDate(date, item)}
